...
def get_lists() -> Dict[str, Any]:
    ...
    _LOGGER.info('Generating resolved, unresolved and backlog lists.')
...
def get_list_intersection_counts() -> Dict[str, int]:
    ...
    """
    _LOGGER.info('Generating the intersection counts between a set of resolved, unresolved and backlog lists.')

    error_lists = _generate_lists()
    # Please, remove flake8 `noqa` comment on the line below when the variables will be used.
    resolved, unresolved, backlog = (  # noqa: F841
        error_lists['resolved'],
        error_lists['unresolved'],
        error_lists['backlog']
    )
